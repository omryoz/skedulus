...
$i=$_POST['page_num']+1; 
 ...
 <tr>
	  ...
	  <a href="javascript:;"  data-toggle="tooltip" onclick=deletethis('<?=base_url()?>services/manage_classes?id=<?php echo $content['id']; ?>&delete=delete&<?php echo $register ?>'); class="tool confirm"  data-original-title="Delete"><i class="icon-trash icon-large"></i></a>
	  </td>
