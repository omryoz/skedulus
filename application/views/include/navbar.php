		  ...
		  <div class="navbar-inner">
			...
			<div class="nav-collapse collapse menu1">			
				<ul class="nav client-navbar justify-nav">
					<li class="">
						<a href="<?php echo base_url();?>cprofile"><center><i class="icon-home"></i><p><?=(lang('Apps_home'))?></p></center></a>
					</li>
					<li class="">
						<a href="<?php echo base_url();?>bcalendar/mycalender"><center><i class="icon-calendar"></i><p><?=(lang('Apps_myappointments'))?></p>
						</center></a>
					</li>
					<li class="">
						<a href="<?php echo base_url();?>clients/favourite"><center><i class="icon-star"></i><p><?=(lang('Apps_favbusiness'))?>
						</p></center>
						</a>
					</li>
