                	...
                	<div class="container <?=(lang('Apps_lang'))?>">
						...
						<div class="nav-collapse collapse menu-top">
							<ul class="nav pull-right" id="main-menu">
								...
								?>
								<li><div > 
								<a href="<?php echo base_url(); ?>common_functions/mydashboard/my" name="my" id="my_selected" class="btn   btn-switch <?php echo $Cclass ?>" oncontextmenu="return false;" ><?=(lang('Apps_personal')) ?></a> 
								<a href="<?php echo base_url(); ?>common_functions/mydashboard/business" name="business" id="business_selected" class="btn  btn-switch <?php echo $Bclass ?>" oncontextmenu="return false;"><?=(lang('Apps_business')) ?></a></div></li>
						...
						<?php }else{?>
                 	 	<div class="nav-collapse collapse menu-top">
							<ul class="nav pull-right" id="main-menu">
							    <li><a href="<?php echo base_url();?>home/businesslist">Business</a></li>
