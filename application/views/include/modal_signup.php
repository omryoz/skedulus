...
<div class="modal-body ">
  <form class="form-horizontal" action="<?php echo base_url(); ?>common_functions/businessSignUp/?checkino" method="POST" name="sign_up" id="sign_up" >
	...
	<div class="login_form">
			...
			<div class="row-fluid">
		   <input  type="text" class="offset3 span6"  placeholder="<?=(lang('Apps_emailaddress'))?>" name="toemail" />
		   </div>
		   <div class="row-fluid">
		   <input type="submit" name="submit" value="<?="Send"?>" class="btn btn-success offset3 span6" value="Reset" />
		   </div>
		   <a href="javascript:;" class="pull-right revert no-dec" onClick="$('#form2').toggle();$('#sign_up').toggle();" title="<?=(lang('Apps_back'))?>"> <i class="icon-reply muted"></i></a>
		   </div>
	</form>
	</div>
</div>
