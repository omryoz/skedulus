		...
		<div class="row-fluid Wrap">
			...
			<h3>Search Businesses</h3>
				<div class="row-fluid strip">
					...
					<div class="span3">
					  <input id="searchTextField" type="text" class="span12 " name="location" size="50" placeholder="Enter a location" autocomplete="on" runat="server" value="<?php echo $location ?>" />  
