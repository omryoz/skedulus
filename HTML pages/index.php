					...
					<div class="sp-slideshow">
						...
						<div class="sp-content">
							...
							<ul class="sp-slider clearfix">
								...
								<li><img src="img/text1.png"><img src="img/calendar1.png"></li>
								<li><img src="img/text2.png"><img src="img/calendar2.png"></li>
								<li><img src="img/text3.png"><img src="img/calendar3.png"></li>
								<li><img src="img/text4.png"><img src="img/calendar4.png"></li>
								<li><img src="img/text5.png"><img src="img/calendar5.png"></li>
							</ul>
						</div><!-- sp-content -->
					</div><!-- sp-slideshow -->
				</div>
					...
					<div class="row-fluid Wrap">
						<div class="wrap_inner">
							...
							<div class="offer">
								...
								<div class=" row-fluid">
									<div class="span8">
										<strong>Hakeem's Aalim</strong>
										<p>Hair Salon</p>
										<small>On <i>pedicure</i></small> 
									</div>
									<div class=" pull-right span4">
										<center>
											<h3>15%</h3>
