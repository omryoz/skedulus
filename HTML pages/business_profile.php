		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<p> I have been an artist in the hair industry for 5 years and now working at the lovely Unparalleled Hair Studio, located in the San Francisco SOMA district.
				 ...
				 <a href="#view_schedule" class="btn btn-primary pull-right span3" role="button"  data-toggle="modal">View schedule </a> 
				 <a href="#book" class="btn btn-primary pull-right span2 offset1" role="button"  data-toggle="modal">Book me </a>
...
<div id="theater_view" class="modal hide fade th3-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <br/><a href="javascript:;" class="btn btn-primary btn-mini">Comment</a>
   </form>
  </div>
