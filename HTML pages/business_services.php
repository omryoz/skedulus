	...
	<div class="row-fluid ">
		<?php include('dash_navbar.php')?>
			...
			<div >
					...
					<div class="">
						<h3 >Services List
						   <a href="#services"  class="btn pull-right btn-primary" data-toggle="modal">+add</a>
						</h3>
      ...
      <textarea rows="3"></textarea>
              ...
              <div class="tab-pane fade" id="staff1">
                ...
                <label class="checkbox">
                 <input type="checkbox" value="">abc</label>
                </p>
                <p class="check1">
                <label class="checkbox">
                 <input type="checkbox" value="" checked>Selected abc</label>
                </p>
                <p class="check1">
                <label class="checkbox">
                 <input type="checkbox" value="">abc</label>
