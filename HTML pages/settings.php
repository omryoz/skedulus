					  ...
					  <div class="tab-pane fade active in" id="Personal">
						  <div class="row-fluid">
							  <div class="span8">
								...
								<div class="span4">
								<a href="#" class="btn icon btn-mini pull-right"><i class="icon-edit" title="edit ">
											</i>
								</a>
											<br/><br/>
							  ...
							  <br/>
								<form class="form-horizontal">
									...
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="password" id="inputPassword2" placeholder="Password" class="span12">
									  </div>
									</div>
									<div class="control-group">
									  <label class="control-label" for="inputPassword">Confirm Password :</label>
									  <div class="controls">
										<input type="password" id="inputPassword3" placeholder="Password" class="span12">
									  </div>
									</div>
									<br/><br/><br/>
									 ...
									 <a href="#" class="btn btn-success pull-right span2">Save</a>
						  ...
						  <div class="row-fluid">
							  ...
							  <br/>
								<form class="form-horizontal">
									...
									<a href="#" class="btn btn-success span2 pull-right">Save</a> 
								</form>
							  </div>
						  </div>
					  </div>
