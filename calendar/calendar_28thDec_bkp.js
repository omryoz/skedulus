...
var rtlDefaults = {
	...
	// dayNamesShort: ['שמש','שלי','יום שלישי','להנשא',"יום ה '","ו '","יום שבת"],
};
            ...
            for (i in displayeventlist) {  
                ...
                // these css classes, can cleaned up much better to have fullcalendar consistent view
                    ...
                    classes = displayeventlist[i].className;
					  ...
					  if(new Date(lday) >= new Date(formatDate(t.start, 'MMMM d, yyyy')) && new Date(lday) < new Date(formatDate(t.end, 'MMMM d, yyyy'))){
