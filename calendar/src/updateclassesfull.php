...
class updateclassesfull 
{
	...
	function return_response()
	{
		...
		$db->query("update user_business_posted_class set user_business_classes_id='".$class."',  start_date='".$sDate."', end_date='".$eDate."', lastdate_enroll='".date("Y-m-d",strtotime($lastDate))."',start_time='".$sTime."',end_time= '".$eTime."',instructor=".$trainer_id.",repeat_type= '".$repeat."'  where id=".$event_id);
