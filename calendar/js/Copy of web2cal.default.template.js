		...
		Web2Cal.defaultPlugins.load=function(opts)
		{
			...
			var createDefaultPreview = function()
			{
				var _html='<div id="previewTemplate"  class="calendarTemplate fullPreviewTemplate " style="display:none">'
						...
						+'		</table>'
						+'		<ul class="actions">'
						+'			{{if (${role} == "manager")}} <li> <a href="javascript:rzEditEvent(\'${eventId}\');" name="edit" class="websbutton"> Edit event </a> </li>'
						+'			<li> <a href="javascript:rzDeleteEvent(\'${eventId}\');" name="delete" class="websbutton"> Delete event </a> </li> {{else}}rising star!{{/if}}'
						+'		</ul>' 
						+'</div>';
					return _html;
			}
