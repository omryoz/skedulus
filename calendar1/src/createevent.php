...
class createevent 
{
	...
	function return_response()
	{
        ...
        $db->query("insert into client_service_appointments(users_id,note,employee_id, start_time,end_time) VALUES ('".$_SESSION['profileid']."', '".$evName."', '".$groupId."', '".$sTimeStr."', '".$eTimeStr."')");
