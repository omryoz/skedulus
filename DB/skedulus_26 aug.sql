...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2013 at 01:17 PM
...
(74, 136, 316, '2013-08-26', ''),
(75, 136, 317, '2013-08-26', ''),
(76, 136, 318, '2013-08-26', ''),
(77, 136, 430, '2013-08-26', ''),
(78, 136, 431, '2013-08-26', ''),
(79, 136, 432, '2013-08-26', ''),
...
(130, 129, '2013-08-15 03:08:00', '2013-08-15 03:08:00', '71', 0, '', 'booked'),
(131, 129, '2013-08-15 08:00:00', '2013-08-15 00:00:00', '73', 130, '', 'booked'),
(132, 136, '2013-08-27 08:15:00', '2013-08-27 09:11:00', '73', 130, 'yes', 'booked');
...
(270, 'employee', 'name@gmail.com', '', 'name1', 'name22', 2147483647, 'male', '0000-00-00', '', 'default.jpg', 'inactive', '1be14dcceb02ab7e5b244862efcdb5c4', '0000-00-00 00:00:00'),
...
(431, 9, '2013-08-30', '2013-08-30', '2013-08-26', '04:00:00', '05:00:00', 226, 'weekly', '', '6,5,4,', '', 4, 3, 65, 0),
...
(430, 9, '2013-08-29', '2013-08-29', '2013-08-26', '04:00:00', '05:00:00', 226, 'weekly', '', '6,5,4,', '', 4, 3, 65, 0),
...
(317, 9, '2013-08-28', '2013-08-28', '2013-08-08', '01:00:00', '01:15:00', 215, 'daily', '1', '', '', 20, 19, 28, 0),
(353, 9, '2013-08-06', '2013-08-06', '2013-08-08', '01:15:00', '02:15:00', 226, 'daily', '1', '', '', 10, 10, 37, 1),
(318, 9, '2013-08-29', '2013-08-29', '2013-08-08', '01:00:00', '01:15:00', 215, 'daily', '1', '', '', 20, 19, 28, 0),
...
(445, 9, '2013-08-27', '2013-08-27', '2013-08-26', '01:15:00', '02:15:00', 215, 'daily', '1', '', '', 6, 5, 70, 0);
...
CREATE VIEW `view_client_class_booking` AS select `client_class_booking`.`note` AS `note`,`client_class_booking`.`date` AS `date`,`client_class_booking`.`user_business_posted_class_id` AS `user_business_posted_class_id`,`client_class_booking`.`users_id` AS `users_id`,`users`.`first_name` AS `first_name`,`users`.`last_name` AS `last_name`,`users`.`phone_number` AS `phone_number`,`users`.`email` AS `email` from (`client_class_booking` join `users` on((`client_class_booking`.`users_id` = `users`.`id`)));
