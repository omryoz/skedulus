...
--
-- Host: localhost
-- Generation Time: Jan 31, 2014 at 12:47 PM
...
(349, 'client', 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'admin', '', '0', 'active', NULL, '0000-00-00', '', '', '', 'active', 0, '', '', '', '', '', '0000-00-00 00:00:00', '0', '0000-00-00 00:00:00'),
...
CREATE TABLE IF NOT EXISTS `user_business_availability` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_business_details_id` (`user_business_details_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3270 ;
