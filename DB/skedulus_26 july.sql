...
--
-- Host: localhost
-- Generation Time: Jul 26, 2013 at 01:02 PM
...
(21, 136, 75, '2013-07-26'),
(20, 136, 78, '2013-07-26');
...
(136, 'client', 'client@gmail.com', 'fac04ca68a48af91f0290001604a2463', 'clientcccccc', 'C', 2147483647, 'female', '1978-03-17', 'abuttsdd ''s this''s is its''s''ssgfgfgdgs', '', 'active', '', '0000-00-00 00:00:00'),
...
(225, 'client', 'eulogik@gmail.com', '7e11d9ba5e138d868fac59f4035dd469', 'eulogik', 'e', 2147483647, 'male', '2064-02-02', '', 'default.jpg', 'active', '0', '2013-07-19 13:50:12'),
...
(1165, 30, 0, 'business', 7, '15:00:00', '15:00:00', '00:00:00', '00:00:00'),
(1164, 30, 0, 'business', 5, '15:15:00', '15:15:00', '00:00:00', '00:00:00'),
(1163, 30, 0, 'business', 4, '15:15:00', '15:15:00', '00:00:00', '00:00:00'),
(1162, 30, 0, 'business', 3, '15:15:00', '15:15:00', '00:00:00', '00:00:00'),
(1161, 30, 0, 'business', 2, '07:00:00', '15:15:00', '00:00:00', '00:00:00'),
(1160, 30, 0, 'business', 1, '07:15:00', '15:15:00', '00:00:00', '00:00:00'),
...
(10, 47, 'class2', 'fixed', 23, 23, 'minutes', 0, 'Before', 30, 'descriptionnn', 18),
...
(47, 1, 210, 'fdfdsf', '', 'dsfdsf', '453543543543545', 'Mumbai, Maharashtra, India', 'class', '19.0759837', '72.87765590000004', 1),
...
INSERT INTO `user_business_posted_class` (`id`, `user_business_classes_id`, `start_date`, `end_date`, `lastdate_enroll`, `start_time`, `end_time`, `instructor`, `repeat_type`, `repeat_all_day`, `repeat_week_days`, `repeat_months`, `class_size`, `availability`) VALUES
(77, 10, '2013-07-21', '2013-07-26', '2013-07-18', '18:00:00', '18:15:00', 215, 'weekly', '', '1,2,3,', '', 20, 0),
(78, 10, '2013-07-21', '2013-07-21', '2013-07-16', '20:00:00', '20:15:00', 215, 'monthly', '', '', '7,8,9,10,11,12,', 25, 21),
(75, 9, '2013-07-21', '2013-07-26', '2013-07-15', '16:00:00', '16:15:00', 215, 'daily', '1', '', '', 30, 27),
(79, 10, '2013-07-21', '2013-07-24', '2013-07-27', '10:00:00', '10:15:00', 226, 'daily', '1', '', '', 40, 39);
...
CREATE  VIEW `skedulus`.`view_business_clients` AS select `skedulus`.`business_clients_list`.`users_id` AS `users_id`,`skedulus`.`business_clients_list`.`user_business_details_id` AS `user_business_details_id`,`skedulus`.`users`.`email` AS `email`,`skedulus`.`users`.`first_name` AS `first_name`,`skedulus`.`users`.`last_name` AS `last_name`,`skedulus`.`users`.`gender` AS `gender`,`skedulus`.`users`.`phone_number` AS `phone_number`,`skedulus`.`users`.`date_of_birth` AS `date_of_birth`,`skedulus`.`users`.`about_me` AS `about_me`,`skedulus`.`users`.`image` AS `image`,`skedulus`.`user_business_details`.`image` AS `business_logo`,`skedulus`.`user_business_details`.`name` AS `business_name`,`skedulus`.`category`.`name` AS `category_name`,`skedulus`.`business_clients_list`.`id` AS `client_list_id`,`manager_details`.`first_name` AS `manager_firstname`,`manager_details`.`last_name` AS `manager_lastname` from ((((`skedulus`.`users` join `skedulus`.`business_clients_list` on((`skedulus`.`users`.`id` = `skedulus`.`business_clients_list`.`users_id`))) join `skedulus`.`user_business_details` on((`skedulus`.`business_clients_list`.`user_business_details_id` = `skedulus`.`user_business_details`.`id`))) join `skedulus`.`category` on((`skedulus`.`user_business_details`.`category_id` = `skedulus`.`category`.`id`))) join `skedulus`.`users` `manager_details` on((`skedulus`.`user_business_details`.`users_id` = `manager_details`.`id`)));
...
CREATE VIEW `skedulus`.`view_business_employees` AS select `skedulus`.`users`.`email` AS `email`,`skedulus`.`users`.`first_name` AS `first_name`,`skedulus`.`users`.`last_name` AS `last_name`,`skedulus`.`users`.`phone_number` AS `phone_number`,`skedulus`.`business_employees`.`user_business_details_id` AS `user_business_details_id`,`skedulus`.`business_employees`.`users_id` AS `users_id`,`skedulus`.`users`.`image` AS `image` from (`skedulus`.`users` join `skedulus`.`business_employees` on((`skedulus`.`business_employees`.`users_id` = `skedulus`.`users`.`id`)));
