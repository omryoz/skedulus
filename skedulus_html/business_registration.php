					...
					<div class="row-fluid">
						...
						<div class="span3 freebox">
							...
							<div class="span10 offset1">
								...
								<a href="businessrg_step2.php" class="btn btn-success"> Subscribe Now !!</a>								</div>
								<div class="span3 freebox">								
									<h3>Silver</h3>
									<div class="span10 offset1">
								<table class="table  subs-tab">
						...
						<a href="businessrg_step2.php" class="btn btn-success"> Subscribe Now !!</a>
					</div>
